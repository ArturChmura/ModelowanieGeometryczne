...
GlobalAxisDrawer::GlobalAxisDrawer(std::shared_ptr<DxDevice> dxDevice)
{
...
void GlobalAxisDrawer::Draw(std::shared_ptr<DxDevice> m_device, std::shared_ptr<Camera> camera)
{
