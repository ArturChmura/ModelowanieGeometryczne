...
int WINAPI wWinMain(HINSTANCE hInstance, HINSTANCE prevInstance, LPWSTR cmdLine, int cmdShow)
{
	...
	DxDevice::windowSize = viewportSize;
	std::shared_ptr<Application> app = std::make_shared<Application>(viewportSize);
...
bool CreateDeviceD3D(HWND hWnd)
{
	...
	DXGI_SWAP_CHAIN_DESC sdAssigned;
	g_pSwapChain->GetDesc(&sdAssigned);
	viewportSize = { (int)sdAssigned.BufferDesc.Width, (int)sdAssigned.BufferDesc.Height };
	return true;
}
